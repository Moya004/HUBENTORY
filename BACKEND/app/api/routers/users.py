...
@router.get('/users/me', response_model=mds.Persona)
async def get_me(curr_user: Persona = Depends(get_current_active_user)):
    return curr_user

@router.get('/users/me/items')
async def read_own_items(curr_user: Persona = Depends(get_current_active_user)):
